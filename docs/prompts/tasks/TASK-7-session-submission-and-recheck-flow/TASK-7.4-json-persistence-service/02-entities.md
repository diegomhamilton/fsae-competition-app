...
- Subtask: TASK#7.4
- Expected PR title: `TASK#7.4: JSON Persistence Service`
- Feature branch: `codex/inspection-event-session-flow`
- Suggested task branch: `codex/inspection-event-session-flow-7-4-json-persistence-service`
- Operation summary: Implement actor-isolated JSON draft persistence with atomic writes, folder creation, stale draft cleanup, and relaunch restore.
