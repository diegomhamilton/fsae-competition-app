...
- Subtask: TASK#7.10
- Expected PR title: `TASK#7.10: Recheck Service`
- Feature branch: `codex/inspection-event-session-flow`
- Suggested task branch: `codex/inspection-event-session-flow-7-10-recheck-service`
- Operation summary: Implement recheck lifecycle from failed test case to open item to accepted review closure after stage submission service boundaries are in place.
