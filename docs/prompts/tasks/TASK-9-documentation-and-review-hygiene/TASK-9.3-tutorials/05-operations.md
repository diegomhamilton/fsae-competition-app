...
- Summary: Add short operational tutorials for common inspection-event extension tasks.
- Scope: Tutorial docs
- Notes: Split tutorials if examples require code changes.
...
2. Create or update only the smallest file set needed for TASK#9.3.
