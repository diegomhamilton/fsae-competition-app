...
Purpose: Add or update documentation frontmatter for indexing and review traceability.
...
`codex/inspection-event-docs-review-hygiene-9-1-documentation-frontmatter`
