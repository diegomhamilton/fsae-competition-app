...
- Summary: Add or update documentation frontmatter for indexing and review traceability.
- Scope: Docs markdown files
- Notes: Split if frontmatter touches unrelated document families.
...
2. Create or update only the smallest file set needed for TASK#9.1.
