...
- Summary: Document branch and PR split rules for feature branches and short-lived task branches.
- Scope: Workflow docs; prompt docs
- Notes: Split when a PR exceeds 10 files or combines unrelated domains.
...
2. Create or update only the smallest file set needed for TASK#9.5.
