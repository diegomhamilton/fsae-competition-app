...
- Summary: Add metadata-first camera/photo capture support for evidence-required steps.
- Scope: Evidence metadata; capture adapter; UI affordance; tests
- Notes: Split if platform permissions or media storage policy enters scope.
...
2. Create or update only the smallest file set needed for TASK#10.8.
