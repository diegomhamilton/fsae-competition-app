...
- Summary: Clarify notes/evidence state labels and persist each state through JSON draft round-trips.
- Scope: Step/test case UI; Strings enums; draft tests
- Notes: Split if evidence state model changes independently.
...
2. Create or update only the smallest file set needed for TASK#10.7.
