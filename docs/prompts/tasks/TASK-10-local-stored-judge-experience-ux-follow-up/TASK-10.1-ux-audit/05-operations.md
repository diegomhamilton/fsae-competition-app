...
- Summary: Audit stored local judge workflow screens for minimum UX polish after TASK#7.
- Scope: Audit doc; view notes; issue checklist
- Notes: Keep audit separate if it finds broad UI changes.
...
2. Create or update only the smallest file set needed for TASK#10.1.
