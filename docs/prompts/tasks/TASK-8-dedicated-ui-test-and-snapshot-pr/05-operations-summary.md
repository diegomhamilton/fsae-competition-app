...
| --- | --- | --- | --- | --- |
| 8.1 | Open the dedicated UI-test PR only after accessibility identifiers and navigation hooks exist. | PR description, prompt docs | Confirm prerequisites from TASK#6 and TASK#7. | Split if prerequisites are incomplete and need implementation fixes. |
