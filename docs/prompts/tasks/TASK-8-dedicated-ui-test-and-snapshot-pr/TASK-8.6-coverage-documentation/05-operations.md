...
- Summary: Document UI automation and snapshot coverage against feature scenarios and personas.
- Scope: Coverage docs; PR validation notes
- Notes: Keep docs separate if test PR is already large.
...
2. Create or update only the smallest file set needed for TASK#8.6.
