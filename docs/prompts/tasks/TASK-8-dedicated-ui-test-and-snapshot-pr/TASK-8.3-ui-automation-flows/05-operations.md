...
- Summary: Add dedicated UI automation flows for the full judge inspection journey.
- Scope: UI automation test files; launch fixtures; accessibility IDs
- Notes: Split by flow family if file count exceeds 10 or failures are hard to isolate.
...
2. Create or update only the smallest file set needed for TASK#8.3.
